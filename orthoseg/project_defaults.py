...
class Train:
    ...
    labelpolygons_pattern: str = '${dirs:labels_dir}/${general:segment_subject}_{image_layer}_polygons.gpkg'  # noqa: E501
    ...
    labellocations_pattern: str = '${dirs:labels_dir}/${general:segment_subject}_{image_layer}_locations.gpkg'  # noqa: E501
...
class Dirs:
    ...
    * OR a relative path starting from the location of the specific projectconfig
    ...
    predict_image_input_dir: str = '${base_image_dir}/${predict:image_layer}/${predict_image_input_subdir}'  # noqa: E501

    predict_image_output_basedir: str = '${predict_image_input_dir}'

    predictsample_image_input_subdir: str = '${train:image_pixel_width}x${train:image_pixel_height}'  # noqa: E501
