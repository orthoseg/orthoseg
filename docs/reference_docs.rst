...
as documented in the :doc:`/reference_docs/orthoseg_cli` page.

As an alternative to the CLI, you can also use the high level Python API to call the
main orthoseg functions. These are documented in the :doc:`/reference_docs/orthoseg_highlevel_api` page.
