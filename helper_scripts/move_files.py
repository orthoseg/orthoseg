...
def remove_wrong_files_from_cache(cachedir: Path):
    ...
    print(f"Cleaned {nb_removed} incorrect files of total {nb_total} files from the cache")
...
def remove_wrong_files_from_cache_go():
    ...
    cachedir = Path(r"\\dg3.be\alp\gistmp\orthoseg\_image_cache\BEFL-2015\2048x2048_128pxOverlap")
