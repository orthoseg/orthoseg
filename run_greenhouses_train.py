...
model_basename = f"greenhouse_02_{segmentation_model}_{backbone_name}_01"
...
model_current_best = "greenhouse_unet_inceptionresnetv2_v1_118_0.02477_0.01867_2"
model_current_best = "greenhouse_linknet_inceptionresnetv2_v2_627_0.02546_0.01443_2"
...
if model_train_dir:
    ...
    model_to_use = 'blabla'
    #model_to_use_filepath = os.path.join(project_dir, model_to_use + ".hdf5")
    model_to_use_filepath = None
else:
